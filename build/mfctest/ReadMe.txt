...
mfctest.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CPsdParserApp 应用程序类。

mfctest.cpp
这是包含应用程序类 CPsdParserApp 的主要应用程序源文件。
...
PsdParserDlg.h，PsdParserDlg.cpp - 对话框
这些文件包含 CPsdParserDlg 类。该类定义应用程序主对话框的行为。该对话框的模板位于 mfctest.rc 中，该文件可以在 Microsoft Visual C++ 中进行编辑。
